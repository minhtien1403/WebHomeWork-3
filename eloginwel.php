...
<body>
	...
	<div class="container-fluid">
		...
		<br>
		<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">BẢNG XẾP HẠNG NHÂN VIÊN XUẤT SẮC </h2>
		...
		<br>
		<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">LƯƠNG</h2>
		...
		<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">TÌNH TRẠNG NGHỈ</h2>
